#ifndef _FALSE_POSITION_HPP_
#define _FALSE_POSITION_HPP_
...
double false_position(const vector<double> &coeff, double a, double b, const double Er = DEFAULT_ER){
...
double false_position(const vector<double> &coeff, const double Er = DEFAULT_ER){
